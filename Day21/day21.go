...
all-expenses-paid trip to Desert Island! It even helpfully drops you off
near the gardener and his massive farm.

"You got the sand flowing again! Great work! Now we just need to wait until
we have enough sand to filter the water for Snow Island and we'll have snow again in no time."
...
in for the day, and so he'd like to know which garden plots he can reach
...
the starting position (either by going north-then-south or by going west-then-east).
...
farm layout; garden plots and rocks repeat as far as you can see.
...
plot marked S on your infinite map, how many garden plots could the
